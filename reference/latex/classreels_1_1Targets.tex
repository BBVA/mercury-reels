\doxysection{reels\+::Targets Class Reference}
\hypertarget{classreels_1_1Targets}{}\label{classreels_1_1Targets}\index{reels::Targets@{reels::Targets}}
...
\begin{center}
\leavevmode
\includegraphics[width=160pt]{classreels_1_1Targets__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=160pt]{classreels_1_1Targets__coll__graph}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Construct a \doxylink{classreels_1_1Targets}{Targets} object from a \doxylink{classreels_1_1Clips}{Clips} object and a Target\+Map. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Predict time to target for all the clients in the \doxylink{classreels_1_1Clips}{Clips} object used to fit the model. \end{DoxyCompactList}\item 
\mbox{\hyperlink{namespacereels_afab3fdb12dfcf2726f495bd074225411}{Times\+To\+Target}} \mbox{\hyperlink{classreels_1_1Targets_a553f2ab5dd3bcec26034115b1d917679}{predict}} (\mbox{\hyperlink{classreels_1_1Clients}{Clients}} \mbox{\hyperlink{reels_8cpp_a34446db4a13547becf65df7e3e1e531d}{clients}})
\begin{DoxyCompactList}\small\item\em Predict time to target for all the clients in a given \doxylink{classreels_1_1Clients}{Clients} object whose clips have been used to fit the model. \end{DoxyCompactList}\item 
...
\Hypertarget{classreels_1_1Targets_a788c0a0b574885ad093398bea7081455}\label{classreels_1_1Targets_a788c0a0b574885ad093398bea7081455} 
...
Construct a \doxylink{classreels_1_1Targets}{Targets} object from a \doxylink{classreels_1_1Clips}{Clips} object and a Target\+Map. 


\begin{DoxyParams}{Parameters}
{\em p\+\_\+clips} & The address of a \doxylink{classreels_1_1Clips}{Clips} object initialized with the clips of a set of clients. \\
\hline
...
\Hypertarget{classreels_1_1Targets_abeacf235481ea5d461876c95b9d0288e}\label{classreels_1_1Targets_abeacf235481ea5d461876c95b9d0288e} 
...
The confidence level is passed as an argument to the \doxylink{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29}{fit()} method, the fit method computes some "{}binomial\+\_\+z.\texorpdfstring{$\ast$}{*}"{} variables used in this function.
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a2986f57a1a97ee8e1c7b2ffb816e3350}\label{classreels_1_1Targets_a2986f57a1a97ee8e1c7b2ffb816e3350} 
...
The upper bound of the AC confidence interval. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a2e193774de3a2ac5920fcac53aed4b6b}\label{classreels_1_1Targets_a2e193774de3a2ac5920fcac53aed4b6b} 
...
The address. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29}\label{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29} 
...
\hline
\end{DoxyParams}
Fit can only be called once in the life of a \doxylink{classreels_1_1Targets}{Targets} object and \doxylink{classreels_1_1Targets_aefdb329ae8284265f37c6fee9f3a074a}{predict()} cannot be called before \doxylink{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29}{fit()}.

\begin{DoxyReturn}{Returns}
True on success. Error is already fitted or wrong arguments. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_aa494e3e344558109a7586f5d46a8c65d}\label{classreels_1_1Targets_aa494e3e344558109a7586f5d46a8c65d} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a96b6945602462b00a810f3489f3a2288}\label{classreels_1_1Targets_a96b6945602462b00a810f3489f3a2288} 
...
\begin{DoxyParams}{Parameters}
{\em p\+\_\+bi} & The address of a Binary\+Image stream containing a previously \doxylink{classreels_1_1Targets_ac4a9e31f024d5b382fa48eec82bfcb9b}{save()}-\/ed image at the cursor position.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
True on success (Most likely error is a wrong stream). 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_afbff88985aa0045475304bc3a56b0ff3}\label{classreels_1_1Targets_afbff88985aa0045475304bc3a56b0ff3} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a6dca89e79ea2f68868bd17326b5d19d5}\label{classreels_1_1Targets_a6dca89e79ea2f68868bd17326b5d19d5} 
...
The density. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a194426a4f66ca447b433b1483c6f9b08}\label{classreels_1_1Targets_a194426a4f66ca447b433b1483c6f9b08} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a0a9bd52e830ad7fe7dd0e5ad07d808e1}\label{classreels_1_1Targets_a0a9bd52e830ad7fe7dd0e5ad07d808e1} 
...
The address. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a903da912dd75677cb03c3c41283d7f9d}\label{classreels_1_1Targets_a903da912dd75677cb03c3c41283d7f9d} 
...
The address. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_aefdb329ae8284265f37c6fee9f3a074a}\label{classreels_1_1Targets_aefdb329ae8284265f37c6fee9f3a074a} 
...
Predict time to target for all the clients in the \doxylink{classreels_1_1Clips}{Clips} object used to fit the model. 

\doxylink{classreels_1_1Targets_aefdb329ae8284265f37c6fee9f3a074a}{predict()} cannot be called before \doxylink{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29}{fit()} and can be called any number of times in all overloaded forms after that.

\begin{DoxyReturn}{Returns}
A vector with the times. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a553f2ab5dd3bcec26034115b1d917679}\label{classreels_1_1Targets_a553f2ab5dd3bcec26034115b1d917679} 
\index{reels::Targets@{reels::Targets}!predict@{predict}}
\index{predict@{predict}!reels::Targets@{reels::Targets}}
...
Predict time to target for all the clients in a given \doxylink{classreels_1_1Clients}{Clients} object whose clips have been used to fit the model. 

It will predict the prediction of the zero-\/length clip (accumulated in the root node) if the client is not found.


\begin{DoxyParams}{Parameters}
{\em clients} & A \doxylink{classreels_1_1Clients}{Clients} object with a subset of the clients used to fit the model.\\
\hline
\end{DoxyParams}
\doxylink{classreels_1_1Targets_aefdb329ae8284265f37c6fee9f3a074a}{predict()} cannot be called before \doxylink{classreels_1_1Targets_a09486f71a7545b25a5a396d87f459d29}{fit()} and can be called any number of times in all overloaded forms after that.
...
A vector with the times. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a616b36f99f75c5592a7fc82febad23d0}\label{classreels_1_1Targets_a616b36f99f75c5592a7fc82febad23d0} 
\index{reels::Targets@{reels::Targets}!predict@{predict}}
\index{predict@{predict}!reels::Targets@{reels::Targets}}
...
A vector with the times. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_aa0711b5c32e23aab8f4656be2484eab1}\label{classreels_1_1Targets_aa0711b5c32e23aab8f4656be2484eab1} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a80b4a813cca93acd4439d1d34036327b}\label{classreels_1_1Targets_a80b4a813cca93acd4439d1d34036327b} 
...
Basically, we assume that the observed maximum likelihood time (mu\+\_\+hat) is the mean (therefore the half) of a uniform distribution U(0, 2\texorpdfstring{$\ast$}{*}mu\+\_\+hat) and the whole "{}event space"{}, if estimated without bias, would be U(0, 2\texorpdfstring{$\ast$}{*}mu\+\_\+hat\texorpdfstring{$\ast$}{*}n\+\_\+seen/n\+\_\+target).

Caveat 1. We don\textquotesingle{}t want it unbiased, but biased by evidence, because many estimates will be done, "{}lucky paths"{} are a real thing, especially with low number of visits. That is why we use \doxylink{classreels_1_1Targets_abeacf235481ea5d461876c95b9d0288e}{agresti\+\_\+coull\+\_\+lower\+\_\+bound()} and not n\+\_\+seen/n\+\_\+target. Note that, of course, as you reduce the confidence (the p argument of fit), you will make it approach n\+\_\+seen/n\+\_\+target.
...
The predicted time to the target event. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_af539c8e3fe2bc1a3f77f32e414bfcbfd}\label{classreels_1_1Targets_af539c8e3fe2bc1a3f77f32e414bfcbfd} 
...
False on error. 
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_ac4a9e31f024d5b382fa48eec82bfcb9b}\label{classreels_1_1Targets_ac4a9e31f024d5b382fa48eec82bfcb9b} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a625045e775f73503e3e9e61b753cfe05}\label{classreels_1_1Targets_a625045e775f73503e3e9e61b753cfe05} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_acc1ee6e15e1250af634a8167868c70ae}\label{classreels_1_1Targets_acc1ee6e15e1250af634a8167868c70ae} 
...
\end{DoxyReturn}
\Hypertarget{classreels_1_1Targets_a428215b5a28ab3c607766c7f57c93f09}\label{classreels_1_1Targets_a428215b5a28ab3c607766c7f57c93f09} 
